        ...
        ScrollView {
            VStack {
                Image("booking").resizable()// accommdations image
                    ...
                    .padding(.bottom , 20)
                Text("Some websites for the international students for booking a private rent:")
                    .font(.headline)
            ...
            Spacer().frame(height : 10)// adding space between sections
                Text("Also, it is dependent on the type of accommodation the students could choose for living, wethere a student wants to stay in a shared room, accommodation with family, or in a hostel.").padding()
            }
        }
    }
