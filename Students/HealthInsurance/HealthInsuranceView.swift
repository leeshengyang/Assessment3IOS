...
struct InsuranceMenu: Identifiable, Hashable {
    ...
    static func all() -> [InsuranceMenu] {
        [
            .init(title: "What is Health Insurance?", systemImageName: "info.circle"),
            .init(title: "Why are international students required to have OSHC?", systemImageName: "questionmark.circle"),
            .init(title: "Who offers and how much it cost?", systemImageName: "dollarsign.circle"),
            .init(title: "What services do OSHC offer to you?", systemImageName: "rectangle.and.text.magnifyingglass"),
            ...
            .init(title: "Where can I go for further information or help?", systemImageName: "info.circle")
        ]
    }
}
